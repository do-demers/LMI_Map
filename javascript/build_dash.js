...
//test commit
//test commit2
function makeMap(error, csd_data, csd_map, adv_data, LMI_data, lmi_ps_noc_data, commute_data, edu_data) {
    ...
    wait = setTimeout(function () {
        ...
        renderMap(csd_map, csd_data, prov_bool, LMI_data, lmi_ps_noc_data, commute_data, adv_data, edu_data);
